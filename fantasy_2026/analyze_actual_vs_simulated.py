...
def main():
    ...
    box_scores_path = Path('/Users/rhu/fantasybasketball3/fantasy_2026/data/matchups/box_scores_latest.csv')
    ...
    for matchup_name in matchups:
        ...
        sim_folder = Path('/Users/rhu/fantasybasketball3/fantasy_2026/fixed_simulations') / sim_folder_name
